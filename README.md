...
| Battery Indicator       |          ✅          |                                     ✅                                     |                                                                                  |
| Bluetooth               |          ✅          |                                     ✅                                     |                                                                                  |
| Camera                  |          🟨          |                                     ✅                                     | Fixed in [x1e-6.19.0-rc7-jg-0](https://github.com/jglathe/linux_ms_dev_kit/tree/jg/ubuntu-qcom-x1e-6.19.0-rc7-jg-0) |
| Display                 |          ✅          |                                     ✅                                     |                                                                                  |
...
| Power Profiles          |          ❌          |                                     ❌                                     |                                                                                  |
| RTC                     |          ✅          |                                     ✅                                     |                                                                                  |
| Speakers                |          🟨          |                                     ✅                                     | [T14s uses hardware/pw limits to fix high volumes](https://github.com/sambow23/nixstuff) |
| Suspend                 |          🟨          |                                     ✅                                     | Battery consumption still high (approx. 3.8%/hour). |
| Thermal throttling      |          ❌          |                                     ❌                                     |                                                                                  |
| Touchpad                |          ✅          |                                     ✅                                     |                                                                                  |
| Touchscreen             |          ✅          |                                     ✅                                     | Fixed in [x1e-6.19.0-rc7-jg-0](https://github.com/jglathe/linux_ms_dev_kit/tree/jg/ubuntu-qcom-x1e-6.19.0-rc7-jg-0) |
| TPM                     |          ❌          |                                     ❌                                     |                                                                                  |
| USB-A                   |         N/A          |                                     ✅                                     |                                                                                  |
| USB-A Booting           |         N/A          |                                     ✅                                     |                                                                                  |
| USB-C 4                 |          ❔          |                                     ❔                                     |                                                                                  |
